...
const Dashboard: React.FC<DashboardProps> = ({ setView }) => {
  const features = [
    ...
    {
      title: 'HOSPITAL CALCULATIONS',
      description: 'IV flow rates, alligation, and other hospital calculations.',
    ...
    {
      title: 'SIG TRAINER',
      description: 'Practice translating between SIG codes and patient instructions.',
      icon: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
              <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 18.75h-9m9 0a3 3 0 013 3h-15a3 3 0 013-3m9 0v-3.375c0-.621-.503-1.125-1.125-1.125h-.871M7.5 18.75v-3.375c0-.621.504-1.125 1.125-1.125h.872m5.007 0H9.497m5.007 0a7.454 7.454 0 01-.982-3.172M9.497 14.25a7.454 7.454 0 00.981-3.172M9.5 3.5h.008v.008H9.5V3.5zm3 0h.008v.008H12.5V3.5z" />
            </svg>,
