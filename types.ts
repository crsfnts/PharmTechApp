export enum View {
  ...
  DaysSupplyOral = 'DAYS_SUPPLY_ORAL',
  DaysSupplyInhaler = 'DAYS_SUPPLY_INHALER',
  DaysSupplyInjectable = 'DAYS_SUPPLY_INJECTABLE',
  Glossary = 'GLOSSARY',
...
export const viewColors: Record<View, string> = {
  ...
  [View.DaysSupplyOral]: 'bg-blue-500',
  [View.DaysSupplyInhaler]: 'bg-blue-500',
  [View.DaysSupplyInjectable]: 'bg-blue-500',
  [View.Glossary]: 'bg-purple-500',
  [View.PillIdentifier]: 'bg-amber-500',
  [View.SigGlossary]: 'bg-emerald-500',
  [View.FlashCards]: 'bg-rose-500',
  [View.Education]: 'bg-indigo-500',
